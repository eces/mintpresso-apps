  ...
  override def onStart(app: Application) {
    ...
    Node.findOneByNo(1) match {
      ...
      case None => {
        ...
        val key = new Key("", 0L, List("*"), List(""), List("read_model", "create_model", "update_model", "delete_model", "search_status", "create_status", "delete_status", "manage_order", "manage_pickup"))
